...
<style>
    ...
    /* Two-line row: the label keeps its ellipsis behaviour, the description
       sits under it in muted, smaller ink. */
    ...
    :global(.command-list .command-item[data-selected] .item-description) {
        color: inherit;
    }
